...
\item Construct $\triangle PQR$ such that $PQ$ = 5,$\angle{Q}$ = \ang{105} and $\angle{R}$ = \ang{40}.
%
%
\section{Solution}
To find angle P:
...
\begin{align}
\mymacro\vec{P} =\myvec{0 \\ 0},
\mymacro\vec{Q} =p\myvec{\cos{\ang{35}} \\ \sin{\ang{35}}},
\mymacro\vec{R} =\myvec{5 \\ 0}
\end{align}
\\
...
%Straight Lines [id:da8497303499289086] 
\draw    (333,61) -- (433,161) ;
%Straight Lines [id:da2366533933463284] 
\draw    (333,61) -- (261,162.33) ;
%Straight Lines [id:da787105812842505] 
\draw    (261,162.33) -- (433,161) ;

% Text Node
\draw (435,164) node [anchor=north west][inner sep=0.75pt]   [align=left] {R};
% Text Node
\draw (320,44) node [anchor=north west][inner sep=0.75pt]   [align=left] {P};
% Text Node
\draw (239,148) node [anchor=north west][inner sep=0.75pt]   [align=left] {Q};


\end{tikzpicture}

\end{figure}
\end{document}\documentclass[journal,12pt,twocolumn]{IEEEtran}
%
\usepackage{setspace}
\usepackage{gensymb}
\singlespacing
